...
export default async function BondDetailPreviewPage({ params }: { params: Promise<{ bondId: string }> }) {
  ...
  return <>
    ...
    <section className="preview-grid preview-grid-3 preview-trader-summary" aria-label="交易前摘要">
    ...
    <section className="preview-grid preview-grid-2">
    ...
    <section className="preview-panel"><div className="preview-panel-head"><div><h2>完整欄位核對</h2><p>缺漏顯示為「—」，不以推測值補齊；適合逐欄比對公告。</p></div></div><dl className="preview-data-grid preview-completeness-grid">
